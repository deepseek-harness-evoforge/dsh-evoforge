...
> 2026-09-04 当前 Hermes revision 复核：V5.135 又建立独立 epoch-3，固定 Hermes `63279301…`；epoch-1/2
> 未改写。严格复跑仍为校准 `2/2`、EvoForge `0` 对 Hermes `1`，结论范围仍仅限确定性发布控制面。详见
> [V5.135 证据](v5-135-hermes-current-ev1-epoch-3-2026-09-04.zh.md)。
