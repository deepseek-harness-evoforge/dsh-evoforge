...
真实 Loader/Agent/Skill/Tool 的后续装配证据见 [P0A.4](p0a-4-dsh-assembled-shadow.zh.md)，三个公开产品 fixture 见 [P0A.5](p0a-5-cache-safe-status.zh.md)、[P0A.6](p0a-6-dispose-owned-watcher.zh.md)与 [P0A.7](p0a-7-profile-install-remove.zh.md)。它们仍不执行任意 Candidate 代码，也不能替代本地未见 final-test。
