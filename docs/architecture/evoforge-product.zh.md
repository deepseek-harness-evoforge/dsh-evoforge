...
| 人类控制 | 状态、证据、审批、暂停、回滚不阻塞会话 | P0C.1 release + P0C.2 review + P0C.3 durable pause/resume + P0C.4 exact bounded diff + P0C.5 protected-effect lexical projection implemented；语义 capability 审计与真实可用性数据 pending |
