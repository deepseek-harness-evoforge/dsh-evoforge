...
| 单机持续运行 | crash-resume、幂等恢复、无半激活版本 | 已设计，未实现 |
...
| 自进化 | 独立 final-test、inactive Candidate、可证明晋升 | 确定性校准/paired final-test + 真实 DSH bridge + 2/3 产品 fixture implemented；最后一个 fixture 与本地未见 case pending |
