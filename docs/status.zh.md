...
| 反事实 Canary 与自动回滚 | `implemented`（P1.2，随 opt-in autoPromote） | [P1.2](evidence/p1-2-counterfactual-canary.zh.md)：exact Git parent/Candidate、原 Case Pack、macOS Sealed Trial、原生 Jobs、pointer race 与 crash recovery | 公开 CI、真实任务 false-promotion/false-rollback/review rate 与多日 soak |
...
- 不能把 P1.1/P2D.1/P1.2 当作已验证的完整 bounded autonomy；已有反事实自动回滚，但尚无真实任务长期误晋升、误回滚和 review-rate 数据；
