...
最新 capability-absent Retention/canary 增量通过根级 `pnpm check`；其中 `dsh-evolve` 58 files passed、
1 file skipped，283 tests passed、2 skipped。Cache Contract 全通过，Doctor 原生合同 22/22，十一包
clean-profile tarball add/dump/boot/真实 Session+Goal+Tool/dispose/remove/reboot/readback 1/1（27.10 秒）。
