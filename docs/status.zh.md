...
- 不能把 P1.1–P1.13/P2D.1 当作已验证的完整 bounded autonomy；已有反馈 intake、私有 Case Draft、既有 evaluator 下的显式后台 Shadow、proposer 前校准、显式/受审查的 Evaluator Draft、单 prior Target 自动 Retention 与反事实自动回滚，但还没有默认后台自动 author/approve，也无真实 provider、真实任务长期误晋升、误回滚、遗忘和 review-rate 数据；
