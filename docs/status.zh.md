...
最新 Gateway Web 增量通过根级 `pnpm check`；其中 `dsh-gateway` 7 files/23 tests、
...
clean-profile tarball add/dump/boot/真实 Session+Goal+Tool/dispose/remove/reboot/readback 1/1（30.04 秒）。
