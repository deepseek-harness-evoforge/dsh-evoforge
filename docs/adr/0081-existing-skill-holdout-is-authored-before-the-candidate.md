...
5. Candidate authoring state 只记录 Envelope identity；治理面和 Web 只投影 phase、exact baseline/evidence identity、聚合成本、retry/failure 和无发布权，不下发保护样本、Skill 内容、evaluator、provider identity 或 Host path。
