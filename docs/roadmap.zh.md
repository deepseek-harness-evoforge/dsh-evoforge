...
| R2 开源仓库就绪 | 完成 | [公共仓库](https://github.com/deepseek-harness-evoforge/dsh-evoforge)、MIT、贡献/安全文档与 Linux/macOS CI |
| P0A Shadow evaluator | 实现中 | P0A.1 tracer 与 macOS Sealed Trial 原语已转绿；完整 Trial、校准和未见 case 尚未完成 |
...
无。公共仓库、GitHub CLI、SSH push 与 CI 已验证。首包固定为 `dsh-evolve`，许可证为 MIT；项目所有者已授权按 P0A 契约自主实现和验证。
