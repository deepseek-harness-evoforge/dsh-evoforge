...
> V4.40 已先修正 Retention 的生成前身份链；V4.41 已由 `ExistingSkillRetentionEvaluation.evaluate()/scan()` 消费 authoritative improved Holdout 与该 exact Retention partition，并接入原生 DSH Jobs；V4.42 已完成权威 DSH Web/真实浏览器。下一门是 existing-Skill Canary、future-Session 晋升和回滚。
> 更新日期：2026-08-21
