...
> V4.40 已要求第五个独立 Goal 在 Candidate proposer 前由单独治理调用形成 calibrated assembled Retention Case Pack，并与 Holdout 一起内容寻址进入 Candidate 已绑定的 v3 Evaluation Envelope；四 Goal及 legacy v2 不得声称具有 Retention，Retention Trial 仍待下一增量。
> 更新日期：2026-08-21
