...
> V4.40–V4.45 已完成生成前 Retention 身份链、exact Retention、独立发布门及最终包浏览器生命周期；V4.46–V4.47 已完成 failed-Outcome Canary、权威 Control/Remote/Web 与独立 expected-active rollback gate。其最终包浏览器故障恢复与两套真实 provider 仍未证明。
> 更新日期：2026-08-21
