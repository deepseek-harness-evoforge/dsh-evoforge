...
|---|---|---|---|---|---|
| `dsh-evolve` | 从自然语言 Goal 与完整原生 Skill catalog 形成可复核 Capability Map/Gap；从显式授信 local Git 或 Agent Skills v0.2 索引发现并安全隔离单文件/归档 whole-Skill；从 durable Gap 派生跨 Goal 需求聚类，再经 DSH Web 三轨研究、text-only whole-Skill v2、独立 Holdout 与一次性 v3 修订形成隔离 Candidate；同时从真实 outcome/反馈形成 Case/Evaluator Draft、Shadow、Retention、canary、review、future-Session 晋升与精确回滚 | P0A + P0B + P0C + P1.1–P1.21 + P2D.1 + V4-1–V4-7 implemented；可信发现、archive 安全隔离、跨 Goal 聚类、原生 Web 研究、整包组合、私有 Holdout、一次修订、admission/Shadow implemented；任意市场/ClawHub 专有接入、真实 provider 整链路、Hermes paired 与长期率待验证 | Skill、Session、Goal、Feedback、Storage、Jobs、Commands、Tools result、FS、Shell、Approval、Token Meter、Web | `report_capability_gap(name)` 只报告 Host 可复核缺口；来源/研究/生成正文不进 Web；unknown/跨域/摘要不符/不安全 archive 均 abstain；cluster 只有 evidence authority，Candidate 不能 install/activate/publish；当前 Session 固定；knowledge 与 verification 物理分栏，v3 绑定 parent/holdout/research 且不能递归修订；评测/holdout/policy 与 proposer 隔离；付费不确定结果不盲重试 | `dsh-evoforge` |
