...
|---|---|---|---|---|---|
| `dsh-evolve` | 从真实任务结果产生 inactive Skill Candidate，独立评测，随后为未来 Session 安全晋升或回滚 | P0A Shadow + P0B Local Continuity + P0C.1 human release command；review inbox 待完成 | Skill、Session、Goal、Feedback、Storage、Jobs、Commands、FS、Shell、Approval、Token Meter | 无新增 Evolve Tool/Prompt；active Generation 复用原生 Skill catalog/body，并按 Session 固定 | `dsh-evoforge` |
