...
export interface EvolutionResearchSkillHoldoutView {
    ...
    readonly results: readonly {
        ...
        readonly skillName: string;
        readonly targetId: string;
        readonly status: 'cancelled' | 'budget-deferred' | 'uncertain' | 'incomplete' | 'pass' | 'fail' | 'inconclusive';
        readonly reason: 'cancelled-before-dispatch' | 'daily-evaluation-budget-exhausted' | 'evaluator-not-independent' | 'local-validation-failed' | 'paid-evaluation-outcome-uncertain' | 'invalid-evaluator-response' | 'all-verification-anchors-satisfied' | 'verification-anchor-failed' | 'verification-anchor-unresolved';
        readonly researchDigest: string;
        readonly candidateTreeHash: string;
...
export interface EvolutionResearchSkillRevisionView {
    ...
    readonly runs: readonly {
        ...
        readonly skillName: string;
        readonly targetId: string;
        readonly status: 'cancelled' | 'budget-deferred' | 'uncertain' | 'incomplete' | 'candidate-ready';
        readonly reason: 'cancelled-before-dispatch' | 'daily-revision-budget-exhausted' | 'local-validation-failed' | 'paid-revision-outcome-uncertain' | 'invalid-reviser-response' | 'candidate-quarantine-failed' | 'revised-candidate-ready';
        readonly holdoutResultId: string;
        readonly researchDigest: string;
        readonly parentTreeHash: string;
        readonly inputDigest: string;
