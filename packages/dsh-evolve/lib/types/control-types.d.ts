...
export interface EvolutionExistingSkillCounterfactualCanaryView {
    ...
    readonly runs: readonly {
        ...
        readonly reason?: 'candidate-still-passes-sealed-canary' | 'candidate-regressed-baseline-recovers' | 'failed-outcome-not-isolated' | 'active-generation-changed' | 'canary-input-mutated' | 'canary-not-assembled' | 'canary-calibration-failed' | 'canary-composition-changed' | 'canary-trial-failed' | 'canary-trial-outcome-uncertain' | 'canary-replay-evidence-invalid';
        readonly startedAt?: string;
        readonly finishedAt?: string;
        readonly evidence?: {
            readonly holdoutCasePackHash: string;
...
export interface ConversationDraftTrialSummary {
    ...
    readonly items: readonly {
        ...
        readonly judge?: {
            readonly version: 'semantic-v1';
            readonly dispatchMarkers: number;
            readonly completedJudgments: number;
            readonly calibrationCompleted: number;
            readonly calibrated: boolean;
        };
        readonly fileEvaluation?: {
            readonly version: 'file-records-v1';
