...
export type EvolutionExistingSkillReleaseReason =
  ...
  readonly automaticPromotion?: {
    ...
    readonly results: readonly {
      ...
      readonly reason:
        ...
        | EvolutionExistingSkillReleaseReason
      readonly generationId?: string
    }[]
  }
...
export type ConversationSkillReleaseReason = 'trial-not-found' | 'policy-unavailable' | 'draft-changed'
  | 'independent-evaluation-required' | 'baseline-unsealed' | 'baseline-changed'
  | 'improvement-not-proven' | 'retention-not-proven' | 'source-unavailable' | 'skill-name-conflict'
  | 'runtime-unavailable'
...
export interface EvolutionActionReceipt {
  ...
  readonly action:
    ...
    | 'approve-review'
    | 'reject-review'
    | 'approve-existing-skill'
    | 'reject-existing-skill'
