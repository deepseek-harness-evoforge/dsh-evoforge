...
.dsh-evolve-table{width:100%;table-layout:fixed;border-collapse:collapse;font-size:11px}.dsh-evolve-table th,.dsh-evolve-table td{text-align:left;vertical-align:top;padding:5px;border-bottom:1px solid var(--dsw-alias-border-l2);overflow-wrap:anywhere}.dsh-evolve-welcome article{overflow-wrap:anywhere}
