      ...
      ? {
          ...
          skillOpportunities: {
            ...
            items: [{
              ...
              goalIds: ['goal-semantic-browser', 'goal-semantic-browser-2'],
              gapCount: 3,
              goalCount: 2,
          ...
          researchHoldout: {
            ...
            results: [{
              ...
              reason: 'verification-anchor-failed' as const,
              researchDigest: '8'.repeat(64),
              ...
              inputTokens: 211,
              outputTokens: 37,
              findings: [{ anchorDigest: 'f'.repeat(64), assessment: 'violated' as const }],
              releaseAuthority: 'none' as const,
            }, {
              id: 'd'.repeat(64),
              candidateId: '4'.repeat(64),
          ...
          researchRevision: {
            ...
            runs: [{
              ...
              parentCandidateId: '3'.repeat(64),
              skillName: 'publish-dsh-plugin',
              targetId: 'publish-research-revision',
