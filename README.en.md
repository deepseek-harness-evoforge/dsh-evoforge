...
> **Pre-alpha: do not use automatic activation in production.** The `dsh-evolve` P0A/P0B/P0C slices, narrow P1.1 auto-promotion, P2D.1 delivery-outcome observation, and P1.2 counterfactual canary/rollback are implemented. The `dsh-software-delivery` Skill, Git verifier, native-Goal verified completion, and idempotent Draft-PR slice are also implemented. Real-task false-promotion/false-rollback data, real-user evidence, and production multi-day evidence remain incomplete.
