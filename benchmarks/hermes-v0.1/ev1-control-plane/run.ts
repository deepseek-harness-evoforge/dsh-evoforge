...
const manifestPath = resolve(suiteRoot, process.env.EVOFORGE_HERMES_EV1_MANIFEST ?? join(benchmarkRoot, 'manifest.json'))
const manifest = JSON.parse(await readFile(manifestPath, 'utf8'))
const allowNewEpoch = process.env.EVOFORGE_HERMES_EV1_ALLOW_NEW_EPOCH === '1'
const expectedResultPath = process.env.EVOFORGE_HERMES_EV1_EXPECTED_RESULT
